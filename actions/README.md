...
- Docker Setup: Authenticate before starting the pinned mirrored BuildKit image. [Docs](docker-setup/README.md)
- Docker Bake: Build caller-owned dependency graphs and return selected image digests. [Docs](docker-bake/README.md)
- Artifact Upload: Upload named ZIP artifacts with explicit retention and compression. [Docs](artifact-upload/README.md)
- Artifact Download: Validate and extract ZIP artifacts into the expected release directories. [Docs](artifact-download/README.md)
